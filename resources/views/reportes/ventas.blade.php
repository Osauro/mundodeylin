...
<body>
    ...
    <main>
        <h1 align="center">Reporte de venta</h1>
        <h3 align="center">{{ $venta->tienda->nombre }}</h3>
        <h4 align="center">{{ $venta->tienda->created_at }}</h4>
        ...
        <table border="1">
            ...
            <tbody>
                ...
                <tr style="border: 0px;">
                    ...
                    <td class="derecha">{{ number_format($venta->items->sum('precio_total'), 2, ',', '') }}</td>
                </tr>
            </tbody>
        </table>
