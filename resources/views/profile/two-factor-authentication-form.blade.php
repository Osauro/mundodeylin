<x-jet-action-section>
    <x-slot name="content">
        ...
        <div class="mt-3 max-w-xl text-sm text-gray-600">
            <p>
                {{ __('Cuando la autenticación de dos factores está habilitada, se le solicitará un token aleatorio seguro durante la autenticación. Puede obtener este token en una aplicación Autenticador en su teléfono.') }}
            </p>
        </div>
